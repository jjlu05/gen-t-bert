...
def loadCandidateTables(benchmark, sourceTableName, originatingTablesDict):
    ...
    dataLakePath = os.path.join(FILEPATH, "datalake")
    if '_mtTables_groundtruth' in benchmark: FILEPATH = os.path.join("datasets",benchmark.split('_mtTables_groundtruth')[0])
